...
<tr>
	...
	<td width="750">
<h4><font color="#843f8b"><div align=center>Modify Birth Details</div></font></h4>

<form action="/chennaicopp/editbirth2.jsp" name="valid" method="post" onsubmit="return Validation()">
    <table align="center">
<tr>
